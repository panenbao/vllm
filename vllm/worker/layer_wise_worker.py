...
class LayerWiseWorker(LocalOrDistributedWorkerBase):
    ...
    def get_parameters(self) -> int:
        return self.model_runner.paramaters
    ...
    def _init_cache_engine(self):
        ...
        self.cache_engine = [
            ...
            if not self.cache_config.enable_layer_wise_cache else
            LayerWiseCacheEngine(self.cache_config, self.model_config,
                                self.parallel_config, self.device_config,
                                self.layer_kv_config, paramaters=self.get_parameters())
